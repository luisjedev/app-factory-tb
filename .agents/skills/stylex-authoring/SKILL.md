...
description: StyleX authoring rules. Use whenever creating, modifying, refactoring, reviewing, or migrating styles for any component in this monorepo, even when the request does not mention StyleX.
---
